...
- [图小小](https://picsmaller.com "Pic Smaller")
- [ShotEasy Compress](https://shoteasy.fun/image-compressor/ "图片压缩")
- [docsmall](https://docsmall.com)
- [wsrv.nl](https://wsrv.nl "图片缓存、调整大小服务")
...
- [Sysinternals](https://learn.microsoft.com/zh-cn/sysinternals/ "Windows 工具")
...
- [Babel Try](https://babel.dev/repl)
...
- [Watchling](https://www.watchling.app)
...
- [DB2DB](https://www.szmesoft.com/product-group/db2db/ "数据库转换工具")
- [db fiddle](https://dbfiddle.uk "免费的在线 SQL 环境进行实验和共享")
- [SQL Online Compiler](https://sqliteonline.com "在线 SQL")
- [pgrust](https://pgrust.com "PostgreSQL Rust")
- [PGlite](https://pglite.dev/repl/ "PostgreSQL")
- [DuckDB](https://shell.duckdb.org)
