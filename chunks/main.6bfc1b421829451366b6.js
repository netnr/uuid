(()=>{"use strict";var e,t,r,a,n,o={330(e){e.exports={rE:"8.0.25"}}},i={};function s(e){var t=i[e];if(void 0!==t)return t.exports;var r=i[e]={exports:{}};return o[e](r,r.exports,s),r.exports}if(s.m=o,s.d=(e,t)=>{for(var r in t)s.o(t,r)&&!s.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},s.f={},s.e=e=>Promise.all(Object.keys(s.f).reduce((t,r)=>(s.f[r](e,t),t),[])),s.u=e=>"chunks/"+e+"."+({230:"bff8d3bad2e787a68fd6",666:"71aa593be09604123451",962:"8fae885f4588091c4e22"})[e]+".js",s.miniCssF=e=>"chunks/"+e+".31e47fd8fa8c0f313200.css",s.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||Function("return this")()}catch(e){if("object"==typeof window)return window}}(),s.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),e={},t="netnr:",s.l=(r,a,n,o)=>{if(e[r])return void e[r].push(a);if(void 0!==n)for(var i,l,c=document.getElementsByTagName("script"),d=0;d<c.length;d++){var u=c[d];if(u.getAttribute("src")==r||u.getAttribute("data-webpack")==t+n){i=u;break}}i||(l=!0,(i=document.createElement("script")).charset="utf-8",s.nc&&i.setAttribute("nonce",s.nc),i.setAttribute("data-webpack",t+n),i.src=r),e[r]=[a];var h=(t,a)=>{i.onerror=i.onload=null,clearTimeout(p);var n=e[r];if(delete e[r],i.parentNode&&i.parentNode.removeChild(i),n&&n.forEach(e=>e(a)),t)return t(a)},p=setTimeout(h.bind(null,void 0,{type:"timeout",target:i}),12e4);i.onerror=h.bind(null,i.onerror),i.onload=h.bind(null,i.onload),l&&document.head.appendChild(i)},s.r=e=>{"u">typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},s.p="/","u">typeof document){var l={792:0};s.f.miniCss=(e,t)=>{if(l[e])t.push(l[e]);else 0!==l[e]&&({962:1})[e]&&t.push(l[e]=new Promise((t,r)=>{var a,n=s.miniCssF(e),o=s.p+n;if(((e,t)=>{for(var r=document.getElementsByTagName("link"),a=0;a<r.length;a++){var n=r[a],o=n.getAttribute("data-href")||n.getAttribute("href");if("stylesheet"===n.rel&&(o===e||o===t))return n}for(var i=document.getElementsByTagName("style"),a=0;a<i.length;a++){var n=i[a],o=n.getAttribute("data-href");if(o===e||o===t)return n}})(n,o))return t();(a=document.createElement("link")).rel="stylesheet",a.type="text/css",s.nc&&(a.nonce=s.nc),a.onerror=a.onload=n=>{if(a.onerror=a.onload=null,"load"===n.type)t();else{var i=n&&n.type,s=n&&n.target&&n.target.href||o,l=Error("Loading CSS chunk "+e+` failed.
...
`),g.showNotification("转换完成","success")}catch(e){console.error(e),g.showNotification("转换失败","error")}})}break;case"about":{let e=`
        ...
        `).join(""),viewLink:async()=>{let e;if(m.flagLocalUsed?m.flagLocalJson&&(e=m.flagLocalJson.libs):e=await g.reqLibs(m.flagName,m.flagResp,m.flagLibs),e){let t=[];for(let r of e)if("file"===r.type&&r.name.endsWith(m.flagSuffix)){let e=r.name.substring(0,r.name.length-m.flagSuffix.length),a=`card-${t.length}`;t.push(`
                    ...
                    `)}m.domCardsContainer.innerHTML=t.join("");let r=0;for(let t of e)if("file"===t.type&&t.name.endsWith(m.flagSuffix)){let e=document.querySelector(`#card-${r} .uuid-card-content`);try{let a=await g.reqRaw(t.download_url);if(a){let t=await s.e(666).then(s.bind(s,666)),n=g.parseSections(t.parse(a));e.innerHTML=g.renderSections(n)||g.emptyState("empty","暂无内容","此文件暂无有效的链接内容");let o=n.reduce((e,t)=>e+t.links.length,0),i=document.querySelector(`#card-${r} .uuid-card-title`);i&&o>0&&(i.innerHTML+=` <span class="uuid-card-count">(${o})</span>`)}else e.innerHTML=g.emptyState("error","加载失败","无法加载此文件的内容")}catch(t){console.error("Error loading card content:",t),e.innerHTML=g.emptyState("error","加载错误","处理文件内容时出现错误")}r++}m.domCardsContainer.dataset.ended=!0}else m.domCardsContainer.innerHTML=g.emptyState("error","加载失败","无法获取收藏夹列表")},updateSilentSearch:e=>{m.domSearchInput.dataset.search=e,m.domSearchInput.placeholder=e.length?e:"静默搜索 (Ctrl+K)...",g.searchLink(e)},searchArrow:e=>{let t=m.domSearchDropdown.querySelectorAll(".uuid-search-item");if(0===t.length)return;let r=m.domSearchDropdown.querySelector(".uuid-search-item.active"),a=-1;t.forEach((e,t)=>{e===r&&(a=t)}),r&&r.classList.remove("active"),"ArrowUp"===e?a=a<=0?t.length-1:a-1:"ArrowDown"===e&&(a=a>=t.length-1?0:a+1),a>=0&&a<t.length&&t[a].classList.add("active")},searchLink:e=>{if(m.domCardsContainer.dataset.ended){let t=[];if(""!==e.trim()){let r=e.toLowerCase(),a=m.domCardsContainer.querySelectorAll("a");for(let e=0;e<a.length;e++){let n=a[e];if(`${n.href},${n.textContent},${n.title||""}`.toLowerCase().includes(r)&&(t.push({url:n.href,title:n.textContent.trim(),tip:n.title||""}),t.length>=7))break}}if(t.length>0){let e=t.map((e,t)=>`
